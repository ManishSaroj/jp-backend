...
const { createJobPost, getEmployerJobPosts, getJobPostById, updateJobPost, getAppliedCandidates, getCandidateDetails} = require('../controllers/Employer/EmployerJobPost');
